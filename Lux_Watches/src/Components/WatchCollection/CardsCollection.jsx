...
// import {Card, ap_1159, cactus_jack, royaloak_perpetual, carrera_date, carrera_porsche, carrera, daydate_green, daydate_gold, daydate_blue,patek_green,patek_teal,patek_blue} from "./images.jsx" 
...
//             <div className="card card-3" onClick={() => navigateToWatch(cactus_jack)}><Card pfp={cactus_jack} name="Code 11.59 by Audemars Piguet" desc="Manual winding ultralat" brand="Rolex"/></div>
