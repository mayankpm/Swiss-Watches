...
export default function Hero() {
  return (
    <div className="relative">
      ...
      <Navbar navPosition={{position: 'absoulute'}} navTextStyle={{color: 'white'}} navBGColor='white' navIcon={{background: 'white'}} navCartIcon='src\assets\cart.svg' navSearchIcon='src\assets\search.svg'/>
